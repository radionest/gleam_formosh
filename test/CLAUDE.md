...
| `all_of_test.gleam` | `schema/composer`, `schema/parser`, `schema/resolver` | 463 | allOf composition: member merging, $ref mixins, collision deep-merge, stricter bounds, unified conditionals, nested/degenerate cases |
